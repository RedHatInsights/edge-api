...
// Source: pkg/common/kafka/consumers.go

// Package mock_kafkacommon is a generated GoMock package.
package mock_kafkacommon

import (
	kafka0 "github.com/redhatinsights/edge-api/pkg/services"
	reflect "reflect"
	time "time"
...
func (mr *MockConsumerServiceMockRecorder) Close() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Close", reflect.TypeOf((*MockConsumerService)(nil).Close))
}

// Start mocks base method.
func (m *MockConsumerService) Start() {
	m.ctrl.T.Helper()
	m.ctrl.Call(m, "Start")
}

// Start indicates an expected call of Start.
func (mr *MockConsumerServiceMockRecorder) Start() *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Start", reflect.TypeOf((*MockConsumerService)(nil).Start))
}
...
func (m *MockConsumerServiceInterface) ConsumeMessage(event models.CRCCloudEvent) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ConsumeMessage", event)
	ret0, _ := ret[0].(error)
	return ret0
}

// ConsumeMessage indicates an expected call of ConsumeMessage.
func (mr *MockConsumerServiceInterfaceMockRecorder) ConsumeMessage(event interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ConsumeMessage", reflect.TypeOf((*MockConsumerServiceInterface)(nil).ConsumeMessage), event)
}

// GetConsumerInstance mocks base method.
func (m *MockConsumerServiceInterface) GetConsumerInstance(consumerGroup string) kafka0.Consumer {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetConsumerInstance", consumerGroup)
	ret0, _ := ret[0].(kafka0.Consumer)
	return ret0
}

// GetConsumerInstance indicates an expected call of GetConsumerInstance.
func (mr *MockConsumerServiceInterfaceMockRecorder) GetConsumerInstance(consumerGroup interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetConsumerInstance", reflect.TypeOf((*MockConsumerServiceInterface)(nil).GetConsumerInstance), consumerGroup)
}
