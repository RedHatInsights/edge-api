...
type RepoBuilderInterface interface {
	BuildUpdateRepo(ut *models.UpdateTransaction, header map[string]string) (*models.UpdateTransaction, error)
...
func (rb *RepoBuilder) BuildUpdateRepo(ut *models.UpdateTransaction, header map[string]string) (*models.UpdateTransaction, error) {
	...
	for _, device := range update.Devices {
		...
		exc, err := playbooks.ExecuteDispatcher(payloadDispatcher, header)
