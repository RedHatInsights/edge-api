...
func (m *MockUpdateServiceInterface) BuildUpdateTransactions(devicesUpdate *models.DevicesUpdate, account, org_id string, commit *models.Commit) (*[]models.UpdateTransaction, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "BuildUpdateTransactions", devicesUpdate, account, org_id, commit)
...
func (mr *MockUpdateServiceInterfaceMockRecorder) BuildUpdateTransactions(devicesUpdate, account, org_id, commit interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "BuildUpdateTransactions", reflect.TypeOf((*MockUpdateServiceInterface)(nil).BuildUpdateTransactions), devicesUpdate, account, org_id, commit)
}
...
func (m *MockUpdateServiceInterface) WriteTemplate(templateInfo services.TemplateRemoteInfo, account, org_id string) (string, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "WriteTemplate", templateInfo, account, org_id)
	ret0, _ := ret[0].(string)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockUpdateServiceInterfaceMockRecorder) WriteTemplate(templateInfo, account, org_id interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "WriteTemplate", reflect.TypeOf((*MockUpdateServiceInterface)(nil).WriteTemplate), templateInfo, account, org_id)
}
...
func (m *MockUpdateServiceInterface) ValidateUpdateSelection(account, org_id string, imageIds []uint) (bool, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ValidateUpdateSelection", account, org_id, imageIds)
	ret0, _ := ret[0].(bool)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockUpdateServiceInterfaceMockRecorder) ValidateUpdateSelection(account, org_id, imageIds interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ValidateUpdateSelection", reflect.TypeOf((*MockUpdateServiceInterface)(nil).ValidateUpdateSelection), account, org_id, imageIds)
}

// ValidateUpdateDeviceGroup mocks base method
func (m *MockUpdateServiceInterface) ValidateUpdateDeviceGroup(account, org_id string, deviceGroupID uint) (bool, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ValidateUpdateDeviceGroup", account, org_id, deviceGroupID)
	ret0, _ := ret[0].(bool)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockUpdateServiceInterfaceMockRecorder) ValidateUpdateDeviceGroup(account, org_id, deviceGroupID interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ValidateUpdateDeviceGroup", reflect.TypeOf((*MockUpdateServiceInterface)(nil).ValidateUpdateDeviceGroup), account, org_id, deviceGroupID)
}
