...
func (m *MockRepoBuilderInterface) DownloadVersionRepo(c *models.Commit, dest string, external bool) (string, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "DownloadVersionRepo", c, dest, external)
	ret0, _ := ret[0].(string)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (mr *MockRepoBuilderInterfaceMockRecorder) DownloadVersionRepo(c, dest, external interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "DownloadVersionRepo", reflect.TypeOf((*MockRepoBuilderInterface)(nil).DownloadVersionRepo), c, dest, external)
}
