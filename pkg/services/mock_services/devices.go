...
func (m *MockDeviceServiceInterface) GetUpdateAvailableForDevice(device inventory.Device, latest bool, imagesLimit, imagesOffSet int) ([]models.ImageUpdateAvailable, error) {
	m.ctrl.T.Helper()
...
func (m *MockDeviceServiceInterface) GetUpdateAvailableForDeviceByUUID(deviceUUID string, latest bool, imagesLimit, imagesOffSet int) ([]models.ImageUpdateAvailable, error) {
	m.ctrl.T.Helper()
